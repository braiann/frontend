...
const Education = ({ animatingOut }: { animatingOut: boolean }) => {
            ...
            {resume.education.map((study, index) => (
                <div key={index} className="relative group/suggestion">
                    ...
                    <Button
                        ...
                        className="w-min absolute bg-transparent right-0 translate-x-full opacity-0 top-1/2 -translate-y-1/2 group-hover/suggestion:opacity-100 hover:opacity-100"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
